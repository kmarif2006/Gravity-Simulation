...
int main() {
    ...
    objs = {
        ...
        //earth
        Object(glm::vec3(3000, 650, 0), glm::vec3(0, 0, -500), 5.97219*pow(10, 23), 5515, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f)),
        //moon
        ...
        Object(glm::vec3(0, 450, 8500), glm::vec3(0, 0, -50), 5.97219*pow(10, 21.5), 5515, glm::vec4(1.0f, 1.0f, 1.0f, 1.0f)),
        Object(glm::vec3(100, 500, 9000), glm::vec3(50, 0, 0), 5.97219*pow(10, 21), 5515, glm::vec4(1.0f, 1.0f, 1.0f, 1.0f)),

        //neptune
        Object(glm::vec3(0, -500, -10500), glm::vec3(-350, 50, 0), 5.97219*pow(10, 23.5), 5515, glm::vec4(0.35f, 0.85f, 0.99f, 0.5f)),
        Object(glm::vec3(350, -450, -10500), glm::vec3(0, 0, -550), 5.97219*pow(10, 21), 5515, glm::vec4(1.0f, 1.0f, 1.0f, 1.0f)),
        Object(glm::vec3(-350, -450, -11050), glm::vec3(0, 0, -550), 5.97219*pow(10, 21), 5515, glm::vec4(1.0f, 1.0f, 1.0f, 1.0f)),
        Object(glm::vec3(0, -450, -11500), glm::vec3(-550, 0, 0), 5.97219*pow(10, 21), 5515, glm::vec4(1.0f, 1.0f, 1.0f, 1.0f))
